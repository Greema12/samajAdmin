...
<div class="content-page">
        ...
        <div class="row">
                     ...
                     <form method="post" action="{{URL::to('/')}}/upcoming/masterUpdate/{{ $list->id }}" enctype="multipart/form-data" >
                           ...
                           {{ csrf_field() }}
                            ...
                            <label >Image</label>
                            <input type="file" name="photo" src="{{ URL::to('/') }}/img/upcoming/{{ $list->photo }}" style="width: 400px; height: 45px;"  class="form-control" >
                                                   
                            </div>
                                       
                            <div class="form-group">
                            <label >Image</label>
                            <input name="photo" type="image" style="width: 400px; height: 200px;" src="{{ URL::to('/') }}/img/upcoming/{{ $list->photo }}" class="form-control">
