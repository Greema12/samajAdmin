...
@endif 
                            ...
                            <form action="{{URL::to('/')}}/keyperson/store1" method="post"  enctype="multipart/form-data">
                            {{ csrf_field() }}      
                            ...
                            <input type="text" name="post"  class="form-control" >
                             ...
                             <input type="hidden" name="key_per_id" value="{{request()->route('id')}}">   
                            <!-- <div class="form-group" >
                            <label >Key_Person_id</label>
                            <input type="text" name="key_per_id"  class="form-control" >
                            </div> -->
