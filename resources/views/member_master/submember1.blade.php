                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                   ...
                                   <h3><span class="ql-size-large">Sub Members Master</span></h3>
                                ...
                                @foreach($member as $list)
                                            <tr>
                                                ...
                                                <td>
                                                  <a href="{{URL::to('/')}}/member_master/viewsubmember/{{ $list->id}}" class="btn btn-lighten-info waves-effect  width-md waves-info" >View Details</a>
                                                </td>
...
@endif
                                                ...
                                                <td>                                      
                       <a class="btn btn-success" href="{{URL::to('/')}}/member_master/submember1Edit/{{$list->id}}" >
