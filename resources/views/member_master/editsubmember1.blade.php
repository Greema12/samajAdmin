...
<div class="content-page">
        ...
        <div class="row">
                     ...
                     <form method="post"  action="{{URL::to('/')}}/member_master/SubmemberUpdate/{{$list->id}}" >
                            ...
                            @endforeach  
                                      <br/><br/><br/>
                                        ...
                                        <div class="">
                                            ...
                                            <a href="{{URL::to('/')}}/member_master/submember1" class="btn btn-secondary waves-effect waves-light" >Cancel</a>
                                        </div>
