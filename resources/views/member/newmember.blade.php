...
@endif 
                                   ...
                                   <h3><span class="ql-size-large">New Member Page</span></h3>
                                  <br/>
<div class="card-body table-bordered mb-1">
                                    <form action="{{URL::to('/')}}/member/store" method="post"  enctype="multipart/form-data">
                                      {{ csrf_field() }}      
                            ...
                            <textarea class="nicEdit-panel form-control" name="short_description" ></textarea>
                            </div>
