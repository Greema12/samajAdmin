...
@endif 
                                   ...
                                   <h3><span class="ql-size-large">Pal Master Page</span></h3>
                                  <br/>
<div class="card-body table-bordered mb-1">
                                    <form action="{{URL::to('/')}}/Pal/store" method="post"  enctype="multipart/form-data">
                                      {{ csrf_field() }}      
                            
                            <div class="form-group" >
                            <label >Pal Code</label>
                            <input type="text" name="pal_code"  class="form-control" >
                            </div>
                                
                            <div class="form-group" >
                            <label >Pal Name</label>
                            <input type="text" name="pal_name"  class="form-control" >
                            </div>
